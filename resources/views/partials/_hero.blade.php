<section class="relative h-72 bg-gradient-to-t from-green-400 to-blue-500 flex flex-col justify-center align-center text-center space-y-4 mb-4">
    ...
    <div class="z-10">
        ...
        <div>
            ...
            @else
            <a href="register.html" class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">Inscrivez vous pour publier</a>
            @endauth
        </div>
    </div>
</section>